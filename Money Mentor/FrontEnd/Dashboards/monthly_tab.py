...
def create_tab(notebook):
    ...
    # ===== Amount =====
    ctk.CTkLabel(container, text="Amount:").grid(row=2, column=0, pady=5)
    ...
    # ===== Type =====
    ctk.CTkLabel(container, text="Type:").grid(row=4, column=0, pady=5)
    type_combo = ctk.CTkComboBox(container, values=["Expense", "Income"], width=150)
    type_combo.grid(row=4, column=1, pady=5)
